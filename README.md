...
Current template is for ratatui v0.30.0, you may check on [release tags](https://github.com/yanganto/ratatui-keybind-template/releases) for the templates with different version of ratatui.
